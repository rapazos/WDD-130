...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for item in symbol_quantity_list:
        ...
        atomic_total=atomic_mass*quantity
        total_molar_mass+=atomic_total
...
def main():
    ...
    element_dictionary=get_periodic_table()
    parsed_list=parse_formula(formula, element_dictionary)
    mass_total=compute_molar_mass(parsed_list, element_dictionary)
