...
W = int (input('Enter the width of the tire: '))
AR = int (input('Enter the aspect ratio of tire: '))
D = int (input('Enter diameter of the tire: '))
...
with open ("volumes_text.txt", "at" ) as vt:
    print(f"{current_date: %Y-%m-%d},  {Volume}, {W}, {AR}, {D} ", file =vt)