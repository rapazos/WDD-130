"""
File: Chemistry Calculator.
Date: 11/04/2022
Author: Scott Kamerath
Purpose: To learn how to Troubleshoot Functions.
"""
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol, quantity in symbol_quantity_list:
        ...
        symbol_quantity_list[symbol] = quantity
        atomic_mass_list = periodic_table_dict[symbol]
        atomic_mass = atomic_mass_list[1]
        
        # Multiply the atomic mass by the quantity.
        # Add the product into the total molar mass.        
        compute_molar_mass = quantity * atomic_mass
...
def main():
    ...
    mass = float(input("Enter the mass of the compund in grams: "))
    element_dict = get_periodic_table()
    parsed_list = parse_formula(formula, element_dict)
    mass_total = compute_molar_mass(parsed_list, element_dict)
    print("total_molar_mass: ", mass_total)    
    print("moles: ", float(mass/mass_total))
    main()
